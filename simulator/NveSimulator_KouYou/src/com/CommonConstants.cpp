...
const int CommonConstants::VNE_ELAPSED_TIME_UNITS = 1000;  // 24 hours
const int CommonConstants::MIN_VNW_DURATION_TIME_UNITS = 70;  //  one hour 3600
const int CommonConstants::MAX_VNW_DURATION_TIME_UNITS = 150;  // three hours: 10800

const int CommonConstants::VNW_REQUEST_TIME_INTERVAL_UNITS = 5; // time interval : 100 seconds
...
const int CommonConstants::MIN_END_USER_REQUEST_DURATION_TIME_UNITS = 40; //  one hour
const int CommonConstants::MAX_END_USER_REQUEST_DURATION_TIME_UNITS = 110; // three hours
