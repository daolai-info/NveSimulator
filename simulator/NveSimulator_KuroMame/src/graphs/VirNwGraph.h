...
public:
	 ...
	 */
	static int compareTwoVirtualNetworks(VirNwGraph* virNw_1,VirNwGraph* virNw_2);

	int getSameFlag() const;
	void setSameFlag(int sameFlag);
...
private:
	...
	int sameFlag; // for comparing with other nve's virtual network: 0: default not same 1: the same
};
